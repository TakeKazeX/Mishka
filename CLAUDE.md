...
│   │   │   ├── component/            SearchBar + SearchStatus + MenuPositionProvider + TriStatePreference + NullablePortPreference + ListEditDialog + RestartRequiredHint + GroupedCardItems（CardSegment/CardItem/groupedCardItems 分段卡片 lazy items）
